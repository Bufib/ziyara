...
Der aktuelle Prüfstand vom 30. August 2026: `npm run validate` mit 140/140 Jest-Tests bestanden, Expo Doctor 21/21, Web-Export mit 29 statischen Routen bestanden, lokaler DB-Lint ohne Anwendungsschemafehler und 224/224 pgTAP-Assertions bestanden. Die neun vorhandenen Playwright-Smokes wurden für diesen Änderungssatz nicht erneut ausgeführt. Die SDK-57-Patchstände blieben auf `expo ~57.0.18`, `expo-constants ~57.0.16` und `expo-font ~57.0.2` ausgerichtet. iOS-/Android-Export und native Gerätetests wurden für diesen Änderungssatz ebenfalls nicht erneut ausgeführt; insbesondere Reiseziele nach einem kalten nativen Neustart, Familienverwaltung, Kofferänderung, kleine Breiten, alle Sprachen, beide Themes und dynamische Schrift müssen proportional zur Änderung manuell geprüft werden.
