...
- Startseite mit dem heutigen und den kommenden veröffentlichten Tagesprogrammen für angemeldete Nutzer sowie wichtigen Städten und hervorgehobenen Orten.
...
- Die Personenübersicht im Adminbereich zeigt nur Name, vertretene Personenzahl, Kofferanzahl, Kontofamilie und Rolle und kann nach Namen gefiltert werden. Die Vergabe aller Rollen einschließlich `admin` öffnet sich erst über einen Knopf am Personeneintrag; neue Konten besitzen standardmäßig die Rolle `user`. Im getrennten Punkt `Familien` legt ein Admin Kontofamilien an, bearbeitet oder löscht sie und ordnet registrierte Konten atomar zu.
...
src/features/daily-program/  Datumsbasierte Tagesplanung, Admineditor und Home-Anzeige
...
| Tab `/` | wie Tabs | heutige/kommende Tagesprogramme, Städte, hervorgehobene Orte sowie aktive Bus-, Status- und Fragerundenhinweise |
