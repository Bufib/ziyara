  ...
  return (
    <Pressable
      ...
      <View style={styles.placeImageContent}>
        <View style={styles.cardHeader}>
          <View style={styles.cardTitle}>
            <ThemedText style={styles.placeImageTitle} type="heading">
              {place.name}
            </ThemedText>
            <ThemedText style={styles.placeImageMeta} type="small">
              {place.province}, {place.country}
            </ThemedText>
          </View>
          <Badge status={place.verificationStatus} />
        </View>
        <ThemedText style={styles.placeImageDescription} type="small">
          {place.shortDescription}
        </ThemedText>
      </View>
    </Pressable>
    ...
    <Screen contentStyle={styles.screenContent} safeAreaEdges={['right', 'bottom', 'left']}>
      <View style={styles.header}>
        <View style={styles.headerText}>
          ...
          {cityRegion ? (
            <CityLocationMap city={title} placeCount={places.length} region={cityRegion} />
          ) : null}
