...
const dictionaries: Record<Language, Record<string, string>> = {
  de: {
    ...
    "questionRound.validation":
      "Die Frage muss mindestens 3 Zeichen enthalten.",
    "admin.description":
      "Verwalte Reiseführung, Busse, Statusabfragen, anonyme Fragen und Benutzer in getrennten Bereichen.",
  ...
  en: {
    ...
    "questionRound.validation":
      "The question must contain at least 3 characters.",
    "admin.description":
      "Manage trip guidance, buses, status checks, anonymous questions, and users in separate sections.",
    "admin.section.bus.description":
  ...
  ar: {
    ...
    "admin.description":
      "أدر إرشاد الرحلة والحافلات واستطلاعات الحالة والأسئلة المجهولة والمستخدمين في أقسام منفصلة.",
    "admin.section.bus.description":
