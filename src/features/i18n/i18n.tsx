...
const dictionaries: Record<Language, Record<string, string>> = {
  de: {
    ...
    "guide.admin.coordinatesHint": "Koordinaten sind optional. Mit ihnen können Teilnehmer Navigation und einmalige Entfernung nutzen.",
    ...
    "questionRound.validation":
      "Die Frage muss mindestens 3 Zeichen enthalten.",
    "admin.description":
      "Verwalte Reiseführung, Busse, Generalalarm, Statusabfragen, anonyme Fragen und Benutzer in getrennten Bereichen.",
    ...
    "admin.section.guidance.description": "Aktuellen Ort, Treffpunkt, Abfahrt und Teilnehmermeldungen live verwalten.",
    "admin.section.guidance.error": "Fehler",
    "admin.section.guidance.inactive": "Nicht veröffentlicht",
    "admin.section.guidance.title": "Reiseführung und Treffpunkt",
    "admin.emptyBody":
  ...
  en: {
    ...
    "guide.admin.coordinatesHint": "Coordinates are optional. They enable navigation and a one-time distance check.",
    ...
    "questionRound.validation":
      "The question must contain at least 3 characters.",
    "admin.description":
      "Manage trip guidance, buses, the general alarm, status checks, anonymous questions, and users in separate sections.",
    ...
    "admin.section.guidance.active": "Live",
    "admin.section.guidance.description": "Manage the current place, meeting point, departure and participant reports live.",
    "admin.section.guidance.error": "Error",
    "admin.section.guidance.inactive": "Not published",
    "admin.section.guidance.title": "Trip guidance and meeting point",
  ...
  ar: {
    ...
    "guide.admin.coordinatesHint": "الإحداثيات اختيارية، وتتيح للمشاركين الملاحة وحساب المسافة لمرة واحدة.",
    ...
    "admin.description":
      "أدر إرشاد الرحلة والحافلات والإنذار العام واستطلاعات الحالة والأسئلة المجهولة والمستخدمين في أقسام منفصلة.",
    ...
    "admin.section.guidance.description": "أدر الموقع الحالي ونقطة اللقاء والمغادرة وبلاغات المشاركين مباشرة.",
    "admin.section.guidance.error": "خطأ",
    "admin.section.guidance.inactive": "غير منشور",
    "admin.section.guidance.title": "إرشاد الرحلة ونقطة اللقاء",
