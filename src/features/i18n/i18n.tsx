...
export const languageOptions: { label: string; nativeLabel: string; value: Language }[] = [
...
const dictionaries: Record<Language, Record<string, string>> = {
  de: {
    ...
    'city.emptyBody': 'Der lokale Katalog enthält dafür noch keinen geprüften Platzhalter.',
    ...
    'home.heroBody':
      'Offline verfügbare Ortsdaten, prüfungsbewusste religiöse Inhalte, Merkliste und eine Karte für Pilgerinnen und Pilger im Irak.',
    'home.heroTitle': 'Plane, lies und besuche heilige Orte mit Ruhe und Sorgfalt.',
    'home.importantCities': 'Wichtige Städte (5)',
    ...
    'map.browserDenied': 'Standortfreigabe wurde abgelehnt oder ist im Browser nicht verfügbar.',
    'map.browserUnsupported': 'Dieser Browser unterstützt keine Standortfreigabe.',
    'map.description':
    ...
    'settings.arabicFontBody': 'Gilt für Platzhalter und geprüfte arabische Inhalte.',
    'settings.arabicFontTitle': 'Arabische Schriftgröße',
    'settings.appearance': 'Darstellung',
    'settings.darkBlue': 'Dunkelblau',
    'settings.languageBody': 'Wähle die Sprache der App-Oberfläche und der lokalen Platzhaltertexte.',
    'settings.languageTitle': 'Sprache',
    'settings.light': 'Hell',
    'settings.lineByLineBody': 'Gruppiert Arabisch, Transliteration und Übersetzung.',
    'settings.lineByLineTitle': 'Zeilenweise Ansicht',
    'settings.reader': 'Lesemodus',
    'settings.theme.dark': 'Dunkel',
    'settings.theme.light': 'Hell',
    'settings.theme.system': 'System',
    'settings.themeBody': 'Der Dunkelmodus nutzt ein ruhiges Dunkelblau statt reinem Schwarz.',
    'settings.themeTitle': 'Farbmodus',
    'sources.current': 'Aktuelle Quellen',
    'sources.empty': 'Quellenangaben werden während der fachlichen Inhaltsprüfung ergänzt.',
  ...
  en: {
    ...
    'bookmarks.emptyBody': 'Save places or reading entries so you can quickly find them offline.',
    ...
    'city.emptyBody': 'The local catalog does not contain a reviewed placeholder for this yet.',
    ...
    'common.toMap': 'To Map',
    'disclaimer.body1': 'This app is a software companion and content container. It is not a religious authority.',
    'disclaimer.body2':
    ...
    'home.heroBody':
      'Offline place data, review-conscious religious content, bookmarks, and a map for pilgrims in Iraq.',
    'home.heroTitle': 'Plan, read, and visit holy places with calm and care.',
    'home.importantCities': 'Important Cities (5)',
    ...
    'map.browserDenied': 'Location access was denied or is not available in the browser.',
    ...
    'map.locationDeniedBody': 'Enable location in device settings to see your position on the map.',
    'map.locationErrorBody':
    ...
    'settings.arabicFontBody': 'Applies to placeholders and reviewed Arabic content.',
    'settings.arabicFontTitle': 'Arabic font size',
    'settings.appearance': 'Appearance',
    'settings.darkBlue': 'Dark blue',
    'settings.languageBody': 'Choose the language for the app interface and local placeholder text.',
    'settings.languageTitle': 'Language',
    'settings.light': 'Light',
    'settings.lineByLineBody': 'Groups Arabic, transliteration, and translation.',
    'settings.lineByLineTitle': 'Line-by-line view',
    'settings.reader': 'Reader',
    'settings.theme.dark': 'Dark',
    'settings.theme.light': 'Light',
    'settings.theme.system': 'System',
    'settings.themeBody': 'Dark mode uses a calm dark blue instead of pure black.',
    'settings.themeTitle': 'Color mode',
    'sources.current': 'Current Sources',
    'sources.empty': 'Source references will be added during specialist content review.',
  ...
  ar: {
    ...
    'bookmarks.clear': 'مسح',
    'bookmarks.emptyBody': 'احفظ الأماكن أو نصوص القراءة لتجدها بسرعة دون اتصال.',
    ...
    'disclaimer.body1': 'هذا التطبيق رفيق برمجي وحاوية محتوى، وليس مرجعية دينية.',
    'disclaimer.body2':
    ...
    'home.heroBody':
      'بيانات أماكن دون اتصال، ومحتوى ديني تحت المراجعة، ومحفوظات، وخريطة للزائرين في العراق.',
    'home.heroTitle': 'خطط واقرأ وزر الأماكن المقدسة بهدوء وعناية.',
    'home.importantCities': 'مدن مهمة (5)',
    ...
    'map.locationDeniedBody': 'فعّل الموقع في إعدادات الجهاز لرؤية موضعك على الخريطة.',
    'map.locationErrorBody': 'تعذر تحميل موقعك الآن. تحقق من GPS أو الأذونات أو اتصال الإنترنت.',
    ...
    'reader.reviewedLine': 'الإصدار {version}. تمت المراجعة بواسطة: {reviewer}.',
    'reader.share': 'مشاركة',
    ...
    'settings.arabicFontBody': 'ينطبق على النصوص المؤقتة والمحتوى العربي المراجع.',
    ...
    'settings.themeBody': 'يستخدم الوضع الداكن أزرق داكنا هادئا بدلا من الأسود الخالص.',
...
export function AppI18nProvider({ children }: PropsWithChildren) {
  const [language, setLanguage] = usePersistentState<Language>('ziyara.language', 'de');
