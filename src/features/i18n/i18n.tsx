...
const dictionaries: Record<Language, Record<string, string>> = {
  de: {
    ...
    "account.partySizeBody":
      "Hier kannst du nachträglich ändern, wie viele Personen durch dieses Konto vertreten werden.",
    ...
    "family.partySizeBody":
      "Zähle dich selbst und alle Familienmitglieder ohne eigenes Handy mit. Für eine Einzelperson bleibt die Zahl auf 1.",
    "family.partySizeLimit": "Mindestens 1, höchstens {maximum} Personen.",
    "family.validation.partySize": "Gib eine Personenzahl zwischen 1 und 50 ein.",
    ...
    "groupCheck.adminActiveBody":
      "Alle normalen Nutzer sehen jetzt ausschließlich diese Abfrage. Die Namen werden live aktualisiert.",
    "groupCheck.adminBody":
      "Starte eine Frage. Bis du sie beendest, bleiben alle anderen App-Bereiche für normale Nutzer gesperrt.",
    ...
    "admin.description":
      "Hier siehst du alle registrierten Konten. Der Zugriff wird zusätzlich von Supabase geprüft.",
    ...
    "auth.registerBody":
      "Erstelle ein Konto für dich oder für deine Familie, wenn nicht alle ein eigenes Handy haben.",
  ...
  en: {
    ...
    "account.partySizeBody":
      "You can change how many people are represented by this account at any time.",
    ...
    "family.partySizeBody":
      "Include yourself and all family members without their own phone. Leave the number at 1 for an individual account.",
    "family.partySizeLimit": "Minimum 1, maximum {maximum} people.",
    "family.validation.partySize": "Enter a number of people between 1 and 50.",
    "groupCheck.actionError":
      "The action could not be completed. Check your connection and try again.",
    "groupCheck.activeLabel": "Required check in progress",
    "groupCheck.adminActiveBody":
      "All regular users can now see only this check. Names update live.",
    "groupCheck.adminBody":
      "Start a question. All other areas remain locked for regular users until you end it.",
    ...
    "admin.description":
      "View every registered account. Access is also verified by Supabase.",
  ...
  ar: {
    ...
    "account.partySizeBody":
      "يمكنك تغيير عدد الأشخاص الذين يمثلهم هذا الحساب في أي وقت.",
    ...
    "family.partySizeBody":
      "احسب نفسك وجميع أفراد العائلة الذين ليس لديهم هاتف خاص. اترك العدد 1 للحساب الفردي.",
    "family.partySizeLimit": "الحد الأدنى 1 والحد الأقصى {maximum} شخصاً.",
    "family.validation.partySize": "أدخل عدداً بين 1 و50 شخصاً.",
    "groupCheck.actionError":
      "تعذر تنفيذ الإجراء. تحقق من الاتصال وحاول مرة أخرى.",
    "groupCheck.activeLabel": "استطلاع إلزامي جارٍ",
    "groupCheck.adminActiveBody":
      "يرى جميع المستخدمين العاديين هذا الاستطلاع فقط الآن، وتُحدَّث الأسماء مباشرة.",
    "groupCheck.adminBody":
      "ابدأ سؤالاً. ستبقى بقية أقسام التطبيق مقفلة للمستخدمين العاديين حتى تنهيه.",
    ...
    "admin.description":
      "يمكنك هنا رؤية جميع الحسابات المسجلة. يتحقق Supabase أيضا من صلاحية الوصول.",
