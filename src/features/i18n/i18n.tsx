...
const dictionaries: Record<Language, Record<string, string>> = {
  de: {
    ...
    "bus.admin.accountSearch": "App-Konto verknüpfen (optional)",
    "bus.admin.accountSearchPlaceholder": "Nach registriertem Namen suchen …",
    "bus.admin.actionError":
      "Die Busaktion konnte nicht gespeichert werden. Prüfe die Verbindung und versuche es erneut.",
    "bus.admin.addBus": "Bus hinzufügen",
    "bus.admin.archive": "Reise archivieren",
    "bus.admin.archiveBody":
      "Die Reise verschwindet aus dem aktiven Busmanagement. Teilnehmer- und Boardingverlauf bleiben erhalten.",
    "bus.admin.archiveConfirm": "Reise archivieren",
    "bus.admin.archiveTitle": "Aktive Reise archivieren?",
    ...
    "bus.admin.createTripBody":
      "Lege zuerst die aktive Reise an. Danach kannst du Busse und einzelne Teilnehmer-IDs zuordnen.",
    "bus.admin.createTripTitle": "Busmanagement einrichten",
    "bus.admin.departureIn": "Geplante Abfahrt in",
    "bus.admin.linkedAccount": "Verknüpft mit: {name}",
    "bus.admin.minutes": "{count} Minuten",
    "bus.admin.noParticipantsBody":
      "Füge mindestens eine Teilnehmer-ID hinzu, bevor du ein Boarding startest.",
    "bus.admin.noParticipantsTitle": "Noch keine Teilnehmer",
    "bus.admin.optionalAccountBody":
      "Ohne Kontoverknüpfung bleibt die Person in der Leiterübersicht sichtbar und kann vom Admin manuell bestätigt werden.",
    "bus.admin.participantCode": "Teilnehmer-ID",
    "bus.admin.participantName": "Anzeigename",
    "bus.admin.participantNamePlaceholder": "Name für die Leiterübersicht",
    "bus.admin.participantTitle": "Teilnehmer einem Bus zuordnen",
    "bus.admin.removeAccountLink": "Verknüpfung entfernen",
    "bus.admin.saveParticipant": "Teilnehmer speichern",
    ...
    "bus.admin.tripSummary": "Busse: {buses} · Teilnehmer: {participants}",
    "bus.departureAt": "Abfahrt: {date}",
    "bus.homeBody": "Für {count} deiner Teilnehmer-IDs läuft eine Busabfrage.",
    "bus.homeTitle": "Bus-Boarding aktiv",
    "bus.loading": "Buszuordnung wird geladen …",
    "bus.navTitle": "Mein Bus",
    "bus.noAssignmentBody":
      "Dein Konto ist noch keiner Teilnehmer-ID zugeordnet. Wende dich an die Reiseleitung.",
    ...
    "questionRound.validation":
      "Die Frage muss mindestens 3 Zeichen enthalten.",
    "admin.description":
      "Verwalte Busse, Statusabfragen, anonyme Fragen und Benutzer in getrennten Bereichen.",
    "admin.section.bus.description":
      "Lege Reisen und Busse an, ordne Teilnehmer-IDs zu und kontrolliere das Boarding live.",
  ...
  en: {
    ...
    "bus.admin.accountSearch": "Link app account (optional)",
    "bus.admin.accountSearchPlaceholder": "Search by registered name …",
    "bus.admin.actionError":
      "The bus action could not be saved. Check your connection and try again.",
    "bus.admin.addBus": "Add bus",
    "bus.admin.archive": "Archive trip",
    "bus.admin.archiveBody":
      "The trip will disappear from active bus management. Participant and boarding history will be retained.",
    "bus.admin.archiveConfirm": "Archive trip",
    "bus.admin.archiveTitle": "Archive active trip?",
    ...
    "bus.admin.createTripBody":
      "Create the active trip first. You can then assign buses and individual participant IDs.",
    "bus.admin.createTripTitle": "Set up bus management",
    "bus.admin.departureIn": "Planned departure in",
    "bus.admin.linkedAccount": "Linked to: {name}",
    "bus.admin.minutes": "{count} minutes",
    "bus.admin.noParticipantsBody":
      "Add at least one participant ID before starting a boarding round.",
    "bus.admin.noParticipantsTitle": "No participants yet",
    "bus.admin.optionalAccountBody":
      "Without an account link, the participant remains visible to leaders and can be confirmed manually by an admin.",
    "bus.admin.participantCode": "Participant ID",
    "bus.admin.participantName": "Display name",
    "bus.admin.participantNamePlaceholder": "Name for the leader overview",
    "bus.admin.participantTitle": "Assign participant to a bus",
    "bus.admin.removeAccountLink": "Remove link",
    "bus.admin.saveParticipant": "Save participant",
    ...
    "bus.admin.tripSummary": "Buses: {buses} · Participants: {participants}",
    "bus.departureAt": "Departure: {date}",
    "bus.homeBody": "A bus check is active for {count} of your participant IDs.",
    "bus.homeTitle": "Bus boarding active",
    "bus.loading": "Loading bus assignment …",
    "bus.navTitle": "My bus",
    "bus.noAssignmentBody":
      "Your account has not been linked to a participant ID yet. Contact your trip leader.",
    ...
    "questionRound.validation":
      "The question must contain at least 3 characters.",
    "admin.description":
      "Manage buses, status checks, anonymous questions, and users in separate sections.",
    "admin.section.bus.description":
      "Create trips and buses, assign participant IDs and monitor boarding live.",
  ...
  ar: {
    ...
    "bus.admin.accountSearch": "ربط حساب في التطبيق (اختياري)",
    "bus.admin.accountSearchPlaceholder": "البحث بالاسم المسجل …",
    "bus.admin.actionError":
      "تعذر حفظ إجراء الحافلة. تحقق من الاتصال وحاول مرة أخرى.",
    "bus.admin.addBus": "إضافة حافلة",
    "bus.admin.archive": "أرشفة الرحلة",
    "bus.admin.archiveBody":
      "ستختفي الرحلة من إدارة الحافلات النشطة، مع الاحتفاظ بسجل المشاركين والصعود.",
    "bus.admin.archiveConfirm": "أرشفة الرحلة",
    "bus.admin.archiveTitle": "أرشفة الرحلة النشطة؟",
    ...
    "bus.admin.createTripBody":
      "أنشئ الرحلة النشطة أولاً، ثم أضف الحافلات وعرّفات المشاركين الفردية.",
    "bus.admin.createTripTitle": "إعداد إدارة الحافلات",
    "bus.admin.departureIn": "المغادرة المخططة بعد",
    "bus.admin.linkedAccount": "مرتبط بالحساب: {name}",
    "bus.admin.minutes": "{count} دقيقة",
    "bus.admin.noParticipantsBody":
      "أضف معرّف مشارك واحداً على الأقل قبل بدء الصعود.",
    "bus.admin.noParticipantsTitle": "لا يوجد مشاركون بعد",
    "bus.admin.optionalAccountBody":
      "يبقى المشارك غير المرتبط بحساب ظاهراً للمشرف، ويمكن للمشرف تأكيده يدوياً.",
    "bus.admin.participantCode": "معرّف المشارك",
    "bus.admin.participantName": "اسم العرض",
    "bus.admin.participantNamePlaceholder": "الاسم الظاهر لإدارة الرحلة",
    "bus.admin.participantTitle": "تعيين مشارك إلى حافلة",
    "bus.admin.removeAccountLink": "إزالة الربط",
    "bus.admin.saveParticipant": "حفظ المشارك",
    ...
    "bus.admin.tripSummary": "الحافلات: {buses} · المشاركون: {participants}",
    "bus.departureAt": "المغادرة: {date}",
    "bus.homeBody": "يوجد تحقق للحافلة لعدد {count} من معرّفات المشاركين المرتبطة بك.",
    "bus.homeTitle": "الصعود إلى الحافلة نشط",
    "bus.loading": "جارٍ تحميل تعيين الحافلة …",
    "bus.navTitle": "حافلتي",
    "bus.noAssignmentBody":
      "لم يُربط حسابك بمعرّف مشارك بعد. تواصل مع إدارة الرحلة.",
    ...
    "admin.description":
      "أدر الحافلات واستطلاعات الحالة والأسئلة المجهولة والمستخدمين في أقسام منفصلة.",
    "admin.section.bus.description":
      "أنشئ الرحلات والحافلات، وعيّن معرّفات المشاركين، وراقب الصعود مباشرة.",
